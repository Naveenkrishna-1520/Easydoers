...
public class InventoryController {
	...
	@GetMapping("/store")
	public ResponseEntity<StoreInventoryDTO> getInventoryByStoreId(@RequestParam String dealerStoreId) {
	...
	public ResponseEntity<Map<String, Object>> updateInventory(@RequestBody UpdateInventoryRequest inventoryRequest) {
